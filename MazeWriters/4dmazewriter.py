...
# this text controls what the file name is. Default is 'MazeTrial4D.txt'
file = 'MazeTrial4D.txt'

# this text controls what you see. Default is 'C', '#', 'U', 'D', 'F', 'B', 'E'.
cell = 'C'
wall = '#'
up = 'U'
down = 'D'
            ...
            for z in range(0, dp):  # for as many boards as there are in the object
                for y in range(0, wd):  # for as many lines as there are in the board
                    for x in range(0, ln):  # for as many characters are there in the line
                        if maze[w][z][y][x] == cell:  # if the character is a cell, make it a cell.
                            draw.write(cell + " ")
                        elif maze[w][z][y][x] == wall:  # if the character is a wall, make it a wall.
                            draw.write(wall + " ")
                        elif maze[w][z][y][x] == up:  # if the character is an up, make it an up.
                            draw.write(up + " ")
                        elif maze[w][z][y][x] == down:  # if the character is a down, make it a down.
                            draw.write(down + " ")
                        elif maze[w][z][y][x] == forward:  # if the character is a forward, make it a forward.
                            draw.write(forward + " ")
                        elif maze[w][z][y][x] == backward:  # if the character is a backward, make it a backward.
                            draw.write(backward + " ")
                        else:  # if an incorrect or invalid letter is printed, make it an error.
                            draw.write(error + " ")
                    draw.write("\n")
                draw.write("\n")
